...
)
{
    ...
    fun actualizarEntrenadorFormulario(
        ...
        val resultadoActualizacion = conexionEscritura.update(
            "ENTRENADOR",
            valoresActualizar, //nombre = Adrian, descripcion = B
            "id=?", // id=1
            parametrosConsultaUpdate // [1]
        )
        conexionEscritura.close()
    ...
    fun consultarEntrenadorPorID(id:Int):BEntrenador?{
        ...
        val scriptConsultaLectura = """
            ...
            """.trimIndent()
        val arreglarParametrosConsultaLectura = arrayOf(id.toString())
        val resultadoConsultaLectura = baseDatosLectura.rawQuery(
            scriptConsultaLectura,
            arreglarParametrosConsultaLectura
        )
        //Logica busqueda
        ...
        if(existeAlMenosUno){
            do{
                val entrenador = BEntrenador(
                    ...
                    resultadoConsultaLectura.getString(2) // DESCRIPCION
                )
